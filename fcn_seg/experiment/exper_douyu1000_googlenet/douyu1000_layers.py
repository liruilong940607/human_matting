...
class Douyu1000SegDataLayer(caffe.Layer):
    ...
    def setup(self, bottom, top):
        ...
        - douyu1000_dir: path to SIFT Flow dir
        ...
        example: params = dict(douyu1000_dir="/path/to/siftflow", split="val")
        """
        # config
        params = eval(self.param_str)
        self.douyu1000_dir = params['douyu_1000_dir']
        ...
        split_f  = '{}/{}.txt'.format(self.douyu1000_dir, self.split)
    ...
    def load_image(self, idx):
        ...
        """
        im = Image.open('{}/Images/{}.png'.format(self.douyu1000_dir, idx))
    ...
    def load_label(self, idx, label_type=None):
        ...
        if label_type == 'semantic':
            label = scipy.io.loadmat('{}/Labels/{}.mat'.format(self.douyu1000_dir, idx))['label']
        else:
