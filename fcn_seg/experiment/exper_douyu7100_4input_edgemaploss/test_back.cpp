layer {
  ...
  python_param {
    ...
    param_str: "{\'data_dir\': \'../../data/douyu_7100\', \'seed\': 1337, \'split\': \'tmp\', \'flip\': 0, \'crop\': 0}"
  }
}
layer {
  name: "conv1/7x7_s2"
...
layer {
  name: "edge/sobelX_abs"
  bottom: "edge/sobelX"
  top: "edge/sobelX_abs"
  type: "AbsVal"
}
layer {
  name: "edge/sobelY_abs"
  bottom: "edge/sobelY"
  top: "edge/sobelY_abs"
  type: "AbsVal"
}
layer 
{
  name: "edge/eltwise"
  type: "Eltwise"
  bottom: "edge/sobelX_abs"
  bottom: "edge/sobelY_abs"
  top: "edge/eltwise"
  eltwise_param {
    operation: SUM
  }
