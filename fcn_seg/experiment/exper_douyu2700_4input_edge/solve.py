...
weights = './snapshot/tmp.caffemodel'
solver.net.copy_from(weights)

#net = caffe.Net('deploy.prototxt', './snapshot/douyu_2700_train_iter_50000.caffemodel', caffe.TEST)
#solver.net.params['edge/score'][0].data[:] = net.params['edge/score'][0].data[:]
# scoring
...
for _ in range(2000):
    solver.step(500)
    #solver.net.save('./snapshot/tmp.caffemodel')
    # N.B. metrics on the semantic labels are off b.c. of missing classes;
    # score manually from the histogram instead for proper evaluation
    print '================== Accuracy in test dataset ======================'
    score_edge.seg_tests(solver, False, test, layer='score', gt='sem')
    print '=================================================================='
